      ...
      >
        ...
        >
          <Box
            ...
            width={isMobile ? "100%" : "230px"} // Set width to full for mobile devices, otherwise fixed width
        ...
        >
          <Box
            ...
            width={isMobile ? "100%" : "260px"} // Set width to full for mobile devices, otherwise fixed width
            margin={isMobile ? "8px 0" : "0 50px"} // Margin between images on large devices
            mb={isMobile ? "16px" : "0"} // Margin bottom for mobile devices
          >
            <Box overflow="hidden" height="100%">
